...
var MainComponent = /** @class */ (function () {
    function MainComponent() {
        ...
        this.afterSend = new EventEmitter();
        this.afterUserSelect = new EventEmitter();
    ...
    MainComponent.decorators = [
        { type: Component, args: [{ selector: 'my-chat',
    ...
    MainComponent.propDecorators = {
        "peoples": [{ type: Input },],
        "current_user_id": [{ type: Input },],
        "my_env": [{ type: Input },],
        "beforeSend": [{ type: Output },],
        "afterSend": [{ type: Output },],
        "afterUserSelect": [{ type: Output },],
    };
